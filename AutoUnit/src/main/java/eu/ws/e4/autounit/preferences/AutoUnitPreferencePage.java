...
public class AutoUnitPreferencePage extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {

	public AutoUnitPreferencePage() {
		super(GRID);
		setPreferenceStore(AutoUnitPlugin.getInstance().getPreferenceStore());
